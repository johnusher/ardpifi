...
// adapted from github.com/goiot/devices/monochromeoled
...
// type OLED interface {
// 	addLabel(img *image.RGBA, x, line int, label string)
// 	clearLine(img *image.RGBA, line int)
// }
...
func (o *OLED) AddLabel(img *image.RGBA, x, line int, label string) {
	lineOffset := (line) * 10
...
func (o *OLED) ClearLine(img *image.RGBA, line int) {
...
func (o *OLED) ShowText(img *image.RGBA, line int, txtLabel string) {
	o.ClearLine(img, line)
	o.AddLabel(img, 0, line, txtLabel)
	o.SetImage(0, 0, img)
	o.Draw()
}
